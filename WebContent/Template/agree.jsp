...
<link href="agree.css" rel="stylesheet" type="text/css">
</head>
<body>
<%--상단 메뉴--%>
...
<div id="help" >홈 > 약관동의</div>
 <p id="ment1">회원가입 약관 및 개인정보처리방침안내의 내용에 동의 하셔야 회원가입 할 수 있습니다.</p>
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.</textarea>
      ...
      <div id="box31">이용약관에 동의하십니까?<input type="checkbox" value="약관" onclick="chk()"/></div>
    </div>
        
    <div id="info">
    <p id="ment22">개인정보 수집 및 이용 동의</p>
    <p id="line2"></p>
    <p id="boxx2"></p>
    <%--개인정보 수집 및 이용 동의 글--%>
        <textarea id="box22"> ■ 수집하는 개인정보 항목

회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.


ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 , 취미
ο 개인정보 수집방법 : 홈페이지(회원가입) , 전화/팩스를 통한 회원가입 , 경품 행사 응모 , 배송 요청 
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.</textarea>       
        ...
        <div id="box32">이용약관에 동의하십니까?<input type="checkbox" value="약관" onclick="chk()"/></div>
      
    
   

    <a href="join.jsp"><button id="btn" type="submit">약관 동의</button></a>
 </div>
</form>
